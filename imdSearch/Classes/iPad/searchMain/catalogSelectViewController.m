...
@implementation catalogSelectViewController
...
{
    if(delegate && [delegate respondsToSelector:@selector(changeCatalog:)])
    {
		[delegate performSelector:@selector(changeCatalog:) withObject:self];
    }
}
