...
@interface UserInfoPadViewController : UIViewController<UIPopoverControllerDelegate,ASIHTTPRequestDelegate,UITextFieldDelegate,UIAlertViewDelegate>{
...
@property (retain, nonatomic) IBOutlet UIButton *baseRealNameBtn;
...
@property (retain, nonatomic) IBOutlet UILabel *dailylimitLabel;
@property (nonatomic, strong) IBOutlet UIButton *baseUserTypeBtn;
